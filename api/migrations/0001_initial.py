# Generated by Django 3.0.5 on 2021-03-31 18:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(default=0, validators=[api.models.validate_year], verbose_name='Год выпуска произведения')),
                ('description', models.CharField(max_length=200, null=True, verbose_name='Описание произведения')),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='item_category', to='api.Categories')),
                ('genre', models.ManyToManyField(blank=True, related_name='item_genre', to='api.Genres')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='api.Titles', verbose_name='Произведение')),
            ],
            options={
